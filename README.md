...
Sistema de análisis de llamadas de emergencia utilizando algoritmos de **clustering K-means** y **Random Forest** para optimizar turnos de operadores y asignación de recurs
